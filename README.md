...
## Описание
Проект по анализу бюджета СФР (официальные данные) с использованием Python и SQL. 
Основная цель — изучение структуры расходов и выявление ключевых категорий затрат.
